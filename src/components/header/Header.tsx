        ...
        <header className="w-screen h-16 bg-white text-black flex items-center justify-between px-4">
            ...
            <div className="left-header flex items-center gap-6">
                ...
                <div className="flex items-center gap-2">
                    <img src={intersection} className="w-6 h-6" alt="Integrations Icon" />
            ...
            <div className="right-header flex items-center gap-6">
                ...
                <div className="bg-gray-100 rounded-full p-2">
                    <img src={magnifying} alt="Search" className="w-6 h-6 cursor-pointer" />
                </div>

                <div className="relative bg-gray-100 rounded-full p-2">
                    <img src={notification} alt="Notifications" className="w-6 h-6 cursor-pointer" />
                ...
                <div className="bg-gray-100 rounded-full p-2">
                    <img src={question} alt="Help" className="w-6 h-6 cursor-pointer" />
                </div>
